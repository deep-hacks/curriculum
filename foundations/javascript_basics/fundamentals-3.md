...
2. [This video](https://www.youtube.com/watch?v=SBwoFkRjZvE) explains 'Function Scope' in its simplest form. 
3. Read this article about [return values](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Return_values).
4. Let's discuss parameters and arguments in the context of the following example function:
